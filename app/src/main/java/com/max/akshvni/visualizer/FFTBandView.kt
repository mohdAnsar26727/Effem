...
class FFTBandView @JvmOverloads constructor(
    ...
    init {
        keepScreenOn = true
        paintBandsFill.color = ContextCompat.getColor(context, R.color.transparent)
        paintBandsFill.style = Paint.Style.FILL

        paintBands.color = ContextCompat.getColor(context, R.color.transparent)
        paintBands.strokeWidth = 1f
        paintBands.style = Paint.Style.STROKE

        paintAvg.color = ContextCompat.getColor(context, R.color.transparent)
        paintAvg.strokeWidth = 2f
        paintAvg.style = Paint.Style.STROKE

        paintPath.color = ContextCompat.getColor(context, R.color.green)
